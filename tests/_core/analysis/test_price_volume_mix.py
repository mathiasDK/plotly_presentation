...
class UpdateDictTest(unittest.TestCase):
    ...
    def test_multiple_period_comparison_with_groupby(self):
        ...
        expected_x = [
            [
                'FY23', 'A ', 'A ', 'A ', 'B ', 'B ', 'B ', 'C ', 'C ', 'C ', 
                'FY24', 'A  ', 'A  ', 'A  ', 'B  ', 'B  ', 'B  ', 'C  ', 'C  ', 'C  ', 
                'FY25'
            ],
            [
                ' ', 'value_effect', 'weight_effect', 'mix_effect', 'value_effect', 'weight_effect', 'mix_effect', 'value_effect', 'weight_effect', 'mix_effect', 
                '  ', 'value_effect', 'weight_effect', 'mix_effect', 'value_effect', 'weight_effect', 'mix_effect', 'value_effect', 'weight_effect', 'mix_effect', 
                '   '
            ]]
        expected_y = [
            32000.0, 1000.0, 0.0, 0.0, 0.0, -1500.0, 0.0, 1500.0, 6000.0, 900.0, 
            39900.0, -1000.0, 0.0, 0.0, 0.0, 1500.0, 0.0, -2400.0, -6900.0, 900.0, 
            32000.0]
        expected_measure = [
            'absolute', 'relative', 'relative', 'relative', 'relative', 'relative', 'relative', 'relative', 'relative', 'relative', 
            'absolute', 'relative', 'relative', 'relative', 'relative', 'relative', 'relative', 'relative', 'relative', 'relative', 
            'absolute'
        ]
        self.assertListEqual(x, expected_x)
