from plotly_presentation._core.analysis_helper.price_volume_mix import price_volume_mix_analysis
...
class Analysis(Plotter):
    ...
    def price_volume_mix_analysis(
        ...
        """
        x, y, measure = price_volume_mix_analysis(df, value_col, weight_col, period_col, groupby_col, aggregated_output)
    ...
    def adjust_yaxis(self, range:list)->go.Figure:
        ...
        y_sin_1 = np.sin(x_sin) * factor + (range[1] - range[0]) * 0.08 + range[0]  # Adjust y value to the given range
